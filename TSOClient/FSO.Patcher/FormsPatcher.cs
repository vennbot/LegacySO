    ...
    public partial class FormsPatcher : Form
    {
        ...
        private async Task<int> ShowErrors(List<string> remaining)
        {
            ...
            Invoke(new Action(() => {
                ...
                var dresult = MessageBox.Show("Couldn't write one or more files. Make sure you are not running an instance of LegacySO! \r\nFiles:\r\n\r\n" + fileList,
        ...
        public void StartFreeSO()
        {
            try
            {
                ...
                {
                    var startArgs = new ProcessStartInfo("mono", "LegacySO.exe " + string.Join(" ", Args));
        ...
        private void EmergencyDownload()
        {
            var result = MessageBox.Show("You've started the patcher without any updates queued. If you wish to update the game, log into the game server and it will tell you what to do.\r\n\r\n" +
                "If you opened this application because LegacySO is unopenable, you can attempt to redownload a neutral client version using this application. Do you want to reinstall LegacySO this way?",
