...
namespace FSO.SimAntics.Model.Routing
{
    ...
    public class VMObstacleSet
    {
        ...
        public VMObstacleSet(IEnumerable<VMObstacle> obstacles)
        {
        ...
        public static VMObstacleSet RoughBalanced(List<VMObstacle> input)
        {
            ...
            return new VMObstacleSet(input);
        }
