        ...
        public async Task BuildUpdate(UpdateGenerationStatus status)
        {
            ...
            try
            {
                ...
                using (var da = api.DAFactory.Get())
                {
                    ...
                    //fetch artifacts
                    //http://servo.freeso.org/guestAuth/repository/download/FreeSO_TsoClient/.lastSuccessful/client-<>.zip //BV-TO-REPAIR
                    //http://servo.freeso.org/guestAuth/repository/download/FreeSO_TsoClient/.lastSuccessful/server-<>.zip //BV-TO-REPAIR
