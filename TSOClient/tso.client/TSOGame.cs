...
namespace FSO.Client
{
    ...
    public class TSOGame : FSO.Common.Rendering.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            {
                FSOProgram.ShowDialog("Content could not be loaded. Make sure that the LegacySO content has been compiled! (ContentSrc/TSOClientContent.mgcb) \r\n\r\n" + e.ToString());
                Exit();
                Environment.Exit(0);
            }
