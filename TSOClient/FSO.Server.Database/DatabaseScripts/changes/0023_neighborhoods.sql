...
CREATE TABLE `fso_nhood_ban` (
  ...
  `ban_reason` VARCHAR(1000) NOT NULL DEFAULT 'You have been banned from using neighborhood gameplay for misuse. For more information, see https://legacyso.org/terms-of-service/',
