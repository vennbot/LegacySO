...
{
    /// <summary>
    /// Bloomfilter, for checking collisions between values.
    /// From: http://bloomfilter.codeplex.com/
    /// </summary>
    /// <typeparam name="T">The type of value to store in the filter.</typeparam>
